...
/**
 * The movement.Velocity class represents a velocity of a ball object.
 * movement.Velocity specifies the change in position on the x and the y axises.
 *
 * @author Amit Twito
 * @since 3.4.19
 */
public class Velocity {
    ...
    /**
     * Constructor for the movement.Velocity class.
     ...
     * @return movement.Velocity made from angle and speed.
     */
