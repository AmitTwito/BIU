...
/**
 * The sprites.Ball class represents a ball object.
...
public class Ball implements Sprite {
    ...
    /**
     * Constructor for the sprites.Ball class.
     * Builds a ball from a center point, radius and a color.
     *
     * @param center          Center point of the ball.
     * @param r               Radius of the ball.
     * @param color           Color of the ball.
     * @param gameEnvironment animations.Game environment of the ball.
     */
     ...
     *
     * @return movement.Velocity of the ball.
     */
    ...
    public void moveOneStep() {
        ...
        //Get the utility.CollisionInfo of the supposed to happen collision on the route of the ball's trajectory.
    ...
    /**
     * Add this ball to the sprites collection of a given animations.Game.
     *
