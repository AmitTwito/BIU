...
/**
 * The collidables.Paddle class represents a paddle object.
 * A collidables.Paddle is a block that is controlled by the arrow keys,
...
public class Paddle extends Block implements Sprite, Collidable {
    ...
    /**
     * Constructor for the collidables.Paddle class.
     *
    ...
    /**
     * @param first  Left value of the moving utility.Region.
     * @param second Right value of the moving utility.Region.
    ...
    /**
     * Sets the hit Regions : each utility.Region changes the ball's velocity differently.
     *
    ...
    /**
     * Returns a new movement.Velocity based on where on the collidables.Paddle the collision occurred.
     *
     * @param hitter          The hitting ball.
     * @param collisionPoint  The collision point of the ball.
     * @param currentVelocity The current velocity of the ball.
     * @return New movement.Velocity based on where on the paddle the collision occurred.
    ...
    public Velocity hit(Ball hitter, Point collisionPoint, Velocity currentVelocity) throws RuntimeException {
        ...
        if (collisionPoint.getY() == getUpperLeft().getY()) {
            ...
            if (this.hitRegions[0].isContains(collisionPoint.getX())) {
                ...
                return Velocity.fromAngleAndSpeed(30, speedOfPaddle);
                ...
                return Velocity.fromAngleAndSpeed(60, speedOfPaddle);
            }
        }
