...
/**
 * The Minus Class represents an expression of minus operator.
 *
 * @author Amit Twito
 */
public class Minus extends BinaryExpression implements Expression {
    ...
    public Expression advancedSimplify() {
        ...
        return new Plus(advSimpleEx1.simplify(), new Neg(advSimpleEx2.simplify()));
    }
}
