...
/**
 * The Log Class represents an expression of Log math function.
 *
 * @author Amit Twito
 */
public class Log extends BinaryExpression implements Expression {
    ...
    public Expression differentiate(String var) {
        ...
        //(Log(base, X))' = 1/(X*Log(e, base) * X'
        Expression top = getSecondArgument().differentiate(var);
        Expression bottom = new Mult(getSecondArgument(), new Log(new Num("e"), getFirstArgument()));
    ...
    public Expression simplify() {
        ...
        //IF both arguments are equal return the Num 1 : Log(X,X) = 1.
        if (getFirstArgument().toString().equals(getSecondArgument().toString())) {
            return new Num(1);
        }
        //If the second argument is 0, return the number 1;
