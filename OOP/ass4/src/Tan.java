...
/**
 * The Tan Class represents an expression of Tan math function.
 *
 * @author Amit Twito
 */
public class Tan extends UnaryExpression implements Expression {
    ...
    public Expression differentiate(String var) {
        ...
        return new Mult(new Div(1, new Pow(new Cos(getFirstArgument()), 2)), innerDiff);
    }
