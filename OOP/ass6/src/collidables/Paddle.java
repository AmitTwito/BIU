...
public class Paddle extends Block implements Sprite, Collidable {
    ...
    /**
     * @param first  Left value of the moving utilities.Region.
     * @param second Right value of the moving utilities.Region.
    ...
    /**
     * Sets the hit Regions : each utilities.Region changes the ball's velocity differently.
     *
